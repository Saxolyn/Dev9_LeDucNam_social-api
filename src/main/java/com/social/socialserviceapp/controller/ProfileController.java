...
public class ProfileController {
    ...
    public Response updateInformation(@Valid @RequestPart String realName, @RequestPart String birthDate,
                                      @RequestPart String occupation, @RequestPart String livePlace,
                                      @RequestPart(value = "avatar", required = false) MultipartFile multipartFile) throws IOException {
        return profileService.updateInformation(realName, birthDate, occupation, livePlace, multipartFile);
    }
